    ...
    return (
        <>
            <div className="font-Exo grid h-[100vh]  dt:h-[80vh] grid-cols-12 grid-rows-12 gap-8 bg-[#fbfbfb] ">
                <h2 className=" mb:row-start-1 mb:row-end-3 col-start-2 col-end-12 mbx:row-start-1 mbx:row-end-3 dt:col-start-7 dt:row-start-2 dt:row-end-4 text-[2rem] dt:text-[3rem] my-auto text-custom-darkgreen font-extrabold">
                    {title}
                </h2>
                <img
                    alt="Arbet Glas"
