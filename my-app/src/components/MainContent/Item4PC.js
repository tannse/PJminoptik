...
const Item4PC = () => {
    return (
        <div className="mbx:hidden mb:hidden dt:grid grid-cols-12 grid-rows-14   h-[100vh]  ">
            <motion.h3
            ...
            <p className="text-black text-[18px] col-start-7 col-end-12 font-Exo line-clamp-3 row-start-7 row-end-9 ">
            ...
            <motion.button
                ...
                viewport={{ once: true }}
                className="StyleButtonNav col-start-7 row-start-9"
            >
            ...
            <motion.img
                ...
                transition={{ duration: 1 }}
                viewport={{ once: true }}
                className=" h-[45vh]  col-start-2 col-end-6 row-start-3 object-none row-end-11 bg-premierColor  z-20"
                src={ServiceCT5}
                alt="Service Item"
            />
        </div>
