...
const VisionPost2 = () => {
    return (
        <div className=" flex flex-col  pt-[50px] border-t-[1px] border-custom-darkgreen justify-center items-center ">
            <div className="w-[calc(100%-10%)]    ">
                <div className="  dt:w-[55%] ">
                    <h2 className="h2CustomPC text-[1.5rem] text-center mt-[40px] py-[20px] bg-bgButton rounded-[20%] text-[#fff]">
                    ...
                    >
                        <li>
                            <p className="DescCustomPC font-semibold text-[#00544a]">
                                Du får svara på frågor om ditt allmäntillstånd,
                                dina arbetsförhållanden och tidigare
                                erfarenheter av glasögon. (Ta gärna med
                                eventuella tidigare glasögon till
                                synundersökningen.)
                            </p>
                        </li>
                        <li>
                            <p className="DescCustomPC font-semibold text-[#00544a]">
                                Vi mäter avståndet mellan dina ögons synaxlar
                                för att kunna placera glasen rätt i bågen.
                            </p>
                        </li>
                        <li>
                            <p className="DescCustomPC font-semibold text-[#00544a]">
                        ...
                        <li>
                            <p className="DescCustomPC font-semibold text-[#00544a]">
                                Höger och vänster ögon koordineras och ögonens
                                samspel undersöks.
                            </p>
                        </li>
                        <li>
                        ...
                        <figcaption className="font-Exo">
                            Våra optiker är legitimerade och arbetar efter ett
                            kvalitetssäkrat system – allt för dina ögons bästa.
                        </figcaption>
                    </ol>
                    <img
                        src={WellcomeImg}
