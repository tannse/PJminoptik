    ...
    return (
        <div className="bg-premierColor">
            <div className="pt-[3.1rem] pb-[13rem] px-[2.4rem] StyleFlexCol">
                ...
                <hr className="w-[50%] mt-[5px]" />
                <span className="pt-[0.6rem] max-w-[80%] StyleTitle text-center">
                    Vi försöker hela tiden att förbättra och utbilda oss.
                </span>
                <p className="pt-[0.6rem] text-white text-center">
                    Allt för att kunna hjälpa dig på bästa sätt. Välkommen att
                    inspireras! Vi har den senaste tekniken för att visa Dig
                    somkund skillnaden på olika glas och alla de kvalitéer som
