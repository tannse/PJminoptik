...
const SupportByMail = (props) => {
    ...
    return (
        <section className={`${supportMail ? "hidden " : " "}`}>
            <div className="bg-bgOverlay overflow-hidden  fixed w-full  top-0 left-0 h-[100vh] transition-transform ease-in-out duration-500 z-[3000] ">
                <div className="fixed w-[680px] rounded-xl bg-premierColor Hidden-scroll-bar max-h-full overflow-y-auto top-[7%] opacity-100  left-[30%] flex justify-center transition-all ease-in-out duration-500  ">
                            ...
                            <div className="bg-[#fff] h-fit px-[40px] rounded-lg py-[20px] max-w-fit">
                                <div className=" flex flex-col font-medium">
                                    <h3 className="mb-[15px] text-custom-darkgreen text-[20px] font-semibold ">
                                        Skicka ett mail till Min-Optik
                                        kundservice
                                    </h3>
                                    <p className="DescCustomPC  mt-[15px]">
                                        Synsams centrala kundservice hanterar
                                        frågor om Lifestyle Glasögonabonnemang,
                                        Lifestyle Linsabonnemang, köp på
                                        synsam.se och frågor om företagsavtal.
                                    </p>
                                    ...
                                    <div className="flex flex-col text-custom-darkgreen font-bold gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="DescCustomPC my-[15px]">
                                                För att kunna hjälpa dig behöver
                                                vi dina personuppgifter. Genom
                                                att skicka din förfrågan
                                                godkänner du att Min Optik
