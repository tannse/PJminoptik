    ...
    return (
        <>
            <div className="font-Exo grid h-[140vh] dt:h-[140vh] grid-cols-12 grid-rows-12 gap-x-[20px] gap-y-[20px] bg-[#d9f8e8] ">
                <h3 className=" mb:row-start-1 mb:row-end-3 mb:col-start-2 mb:col-end-12 col-end-13 dt:col-start-4 dt:col-end-10 dt:row-start-1 dt:row-end-3 text-[27px] dt:text-[3rem] dt:text-center  m-auto text-custom-darkgreen font-extrabold">
                    {titleFirst}
                </h3>
                <p className="mb:row-start-7 mb:row-end-10 mb:col-start-2 mb:col-end-12 row-start-8 row-end-11 dt:col-start-2 dt:col-end-5 dt:row-start-2 dt:row-end-5 text-center m-auto text-custom-darkgreen dt:DescCustomPC">
                    {descFirst}
                </p>
                <p className="mb:row-start-7 mb:row-end-10 mb:col-start-2 mb:col-end-12 row-start-8 row-end-11 dt:col-start-5 dt:col-end-9 dt:row-start-2 dt:row-end-5 text-center m-auto text-custom-darkgreen dt:DescCustomPC">
                    {descSecond}
                </p>
                <p className="mb:row-start-7 mb:row-end-10 mb:col-start-2 mb:col-end-12 row-start-8 row-end-11 dt:col-start-9 dt:col-end-12 dt:row-start-2 dt:row-end-5 text-center m-auto text-custom-darkgreen dt:DescCustomPC">
                    {descThird}
                </p>
                <p className="mb:row-start-7 mb:row-end-10 mb:col-start-2 mb:col-end-12 row-start-8 row-end-11 dt:col-start-2 dt:col-end-12 dt:row-start-4 dt:row-end-6 text-center m-auto text-custom-darkgreen text-[24px] font-bold">
                    {descFour}
                </p>
                <img
