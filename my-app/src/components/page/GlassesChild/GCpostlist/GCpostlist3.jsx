    ...
    return (
        <>
            <div className="font-Exo grid h-[100vh] dt:h-[50vh] grid-cols-12 grid-rows-8 dt:grid-rows-6">
                <h1 className="col-start-2 col-end-12 dt:col-end-7 row-start-1  text-[2rem] dt:text-[3rem] font-bold  mt-[2rem]  dt:mt-[-10px] text-custom-darkgreen">
                    {title}
                </h1>
                ...
                <p className="col-start-2 col-end-12 row-start-8 dt:row-start-6 mt-[-40px]  text-custom-darkgreen DescCustomPC">
                    {desc?.four}
                </p>
            </div>
        </>
