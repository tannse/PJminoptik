...
export const WorkGlassPost3 = (props) => {
    ...
    return (
        <>
            <>
                <div className="font-Exo grid h-[100vh] grid-cols-12 grid-rows-12 gap-10">
                    <img
                        alt="arbet Glas"
                    ...
                    <p className="col-start-2 col-end-12 row-start-8 row-end-9 mt-[40px] dt:col-start-8 dt:col-end-12 dt:row-start-6 dt:row-end-8 DescCustomPC ">
                        {desc.first}
                    </p>
                    <p className="col-start-2 col-end-12 row-start-11 row-end-12 dt:col-start-8 dt:col-end-12 dt:row-start-9 dt:row-end-10 font-semibold DescCustomPC ">
                        {desc.second}
                    </p>
                </div>
            </>
