    ...
    return (
        <section className="h-fit flex flex-col items-center dt:flex-row  justify-center mt-[5rem] ">
            <div className="w-[calc(100%-20%)]  ">
                <motion.div
                    {...ShowLeftAnimate}
                    className="w-full flex flex-col items-center dt:gap-0 gap-5  "
                >
                    <h2
                        className="h2CustomMobile text-[3rem] text-[#00544a]
                        "
                    >
                        VÄLKOMMEN TILL VÅR NYA TJÄNST LENSREFILL
                    </h2>
                    <hr className="dt:mt-3 dt:w-[50%] " />
                    <p className="DescCustomPC text-[1rem] font-semibold mt-5">
