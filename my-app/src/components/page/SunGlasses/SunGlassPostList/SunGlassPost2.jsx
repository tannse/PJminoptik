    ...
    return (
        <>
            <div className="font-Exo grid h-[200vh]  dt:h-[120vh] grid-cols-12 grid-rows-12">
                <motion.h2
                    {...ShowLeftAnimate}
                    className=" mb:row-start-1 mb:row-end-2 col-start-2 col-end-12 dt:col-end-7 dt:row-start-1 dt:row-end-4 text-[27px] dt:text-[3rem] my-auto text-center text-custom-darkgreen font-extrabold"
                >
                    {titleFirst}
                </motion.h2>
